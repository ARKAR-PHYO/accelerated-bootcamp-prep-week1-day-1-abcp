var beyoncessam = 500 + 750 + 3000 + 5100 + 12980 + 9087 + 50000

console.log("Dear Beyonce,")
console.log("We have calculated your total earnings this year.")
console.log("You have earned " + beyoncessam)
console.log("Of" + beyoncessam + " some portion derives from your live performances.")
console.log("Of" + beyoncessam + " some portion derives from music sales.")
